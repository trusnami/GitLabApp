...
//            Log.d("LoginActivity","json :"+json);
            ...
            try {
                ...
                Request request = new Request.Builder().url("http://115.29.184.56:8090/api/user/auth").post(requestBody).build();
            ...
            Gson gson = new Gson();
            person = gson.fromJson(responseData, Person.class);
            if (person == null){
                return false;
            }
...
//                mPasswordView.requestFocus();
                Toast.makeText(LoginActivity.this,"username or password incrrect",Toast.LENGTH_SHORT).show();
            }
        }
